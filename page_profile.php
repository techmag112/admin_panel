        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-user'></i> <?=htmlspecialchars($res['username'])?>
                </h1>
            </div>
            <div class="row">
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?=htmlspecialchars($res['phone'])?></a>
                                    <a href="mailto:oliver.kopyov@marlin.ru" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?=htmlspecialchars($res['email'])?></a>
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?=htmlspecialchars($res['address'])?>
                                    </address>
                                </div>
                            </div>
                        </div>

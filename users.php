                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=strtolower($item["username"])?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?=$status[$item["status"]]?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?=$item["image"]?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                            <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                                <?=$item["username"]?>
                                                <?php if(is_admin(get_auth_user()) || is_equal($item, get_auth_user())): ?>
                                            ...
                                            <?php endif;?>                                            
                                    <span class="text-truncate text-truncate-xl"><?=$item["job_title"]?></span>
                                </div>
